...
IF(NOT LIBBULLETDYNAMICS AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
IF(NOT LIBBULLETCOLLISION AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
IF(NOT LIBBULLETMATH AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
IF(NOT LIBBULLETSOFTBODY AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
IF(NOT LIBBULLETMULTITHREADED AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
IF(NOT LIBBULLETDYNAMICS_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG")
    MESSAGE ("WARNING: Could not find Bullet Dynamics Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETDYNAMICS_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
...
IF(NOT LIBBULLETCOLLISION_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
    MESSAGE ("WARNING: Could not find Bullet Collision Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETCOLLISION_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
...
IF(NOT LIBBULLETMATH_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
    MESSAGE ("WARNING: Could not find Bullet Math Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMATH_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
...
IF(NOT LIBBULLETSOFTBODY_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
    MESSAGE ("WARNING: Could not find Bullet SoftBody Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETSOFTBODY_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
...
IF(NOT LIBBULLETMULTITHREADED_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
    MESSAGE ("WARNING: Could not find Bullet MultiThreaded Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMULTITHREADED_DEBUG AND CMAKE_BUILD_TYPE EQUAL "DEBUG"))
...
IF(BULLET_FOUND AND CMAKE_BUILD_TYPE EQUAL "RELEASE")
...
ELSEIF(BULLET_FOUND AND CMAKE_BUILD_TYPE EQUAL "DEBUG")
