...
IF(NOT LIBBULLETDYNAMICS AND CMAKE_BUILD_TYPE STREQUAL "Release")
    MESSAGE ("WARNING: Could not find Bullet Dynamics - depending targets will be disabled.")
ENDIF(NOT LIBBULLETDYNAMICS AND CMAKE_BUILD_TYPE STREQUAL "Release")
...
IF(NOT LIBBULLETCOLLISION AND CMAKE_BUILD_TYPE STREQUAL "Release")
    MESSAGE ("WARNING: Could not find Bullet Collision - depending targets will be disabled.")
ENDIF(NOT LIBBULLETCOLLISION AND CMAKE_BUILD_TYPE STREQUAL "Release")
...
IF(NOT LIBBULLETMATH AND CMAKE_BUILD_TYPE STREQUAL "Release")
    MESSAGE ("WARNING: Could not find Bullet Math - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMATH AND CMAKE_BUILD_TYPE STREQUAL "Release")
...
IF(NOT LIBBULLETSOFTBODY AND CMAKE_BUILD_TYPE STREQUAL "Release")
    MESSAGE ("WARNING: Could not find Bullet SoftBody - depending targets will be disabled.")
ENDIF(NOT LIBBULLETSOFTBODY AND CMAKE_BUILD_TYPE STREQUAL "Release")
...
IF(NOT LIBBULLETMULTITHREADED AND CMAKE_BUILD_TYPE STREQUAL "Release")
    MESSAGE ("WARNING: Could not find Bullet MultiThreaded - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMULTITHREADED AND CMAKE_BUILD_TYPE STREQUAL "Release")
...
IF(NOT LIBBULLETDYNAMICS_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    MESSAGE ("WARNING: Could not find Bullet Dynamics Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETDYNAMICS_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
...
IF(NOT LIBBULLETCOLLISION_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    MESSAGE ("WARNING: Could not find Bullet Collision Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETCOLLISION_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
...
IF(NOT LIBBULLETMATH_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    MESSAGE ("WARNING: Could not find Bullet Math Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMATH_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
...
IF(NOT LIBBULLETSOFTBODY_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    MESSAGE ("WARNING: Could not find Bullet SoftBody Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETSOFTBODY_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
...
IF(NOT LIBBULLETMULTITHREADED_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
    MESSAGE ("WARNING: Could not find Bullet MultiThreaded Debug - depending targets will be disabled.")
ENDIF(NOT LIBBULLETMULTITHREADED_DEBUG AND CMAKE_BUILD_TYPE STREQUAL "Debug")
...
IF(BULLET_FOUND AND CMAKE_BUILD_TYPE STREQUAL "Release")
	#MESSAGE ("Bullet found (${BULLET_INCLUDE_DIR}) (${BULLET_LIBRARIES})") # don't list debug libraries for release mode.
	MARK_AS_ADVANCED(BULLET_INCLUDE_DIR BULLET_LIBRARIES BULLET_LIBRARIES_DEBUG)
ELSEIF(BULLET_FOUND AND CMAKE_BUILD_TYPE STREQUAL "Debug")
	#MESSAGE ("Bullet (Debug) Found (${BULLET_INCLUDE_DIR}) (${BULLET_LIBRARIES_DEBUG})")
	MARK_AS_ADVANCED(BULLET_INCLUDE_DIR BULLET_LIBRARIES_DEBUG)
ENDIF(BULLET_FOUND AND CMAKE_BUILD_TYPE STREQUAL "Release")
